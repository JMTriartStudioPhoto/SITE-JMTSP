...
if (tarteaucitronForceLanguage == ''){ var tarteaucitronForceLanguage = 'fr'; }var tarteaucitronCustomText = {"privacyUrl":"Politique de cookies","personalize":"S\u00e9lectionner les cookies","modalWindow":".","alertSmall":"Gestion des cookies","alertBigPrivacy":"Nous utilisons des cookies pour optimiser notre site web et nos services","acceptAll":"Accepter les cookies"};!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e((t=t||self).tarteaucitron_block={})}(this,function(t){"use strict";function l(e,t){/*if (!tarteaucitronIsMagicPossible) {return;}*/return e&&(!t||t!==u)&&(!a.blacklist||a.blacklist.some(function(t){if (t.test(e) && tarteaucitronIsMagicPossible) {tarteaucitronMagic += "_"+tarteaucitron_services[t.toString().replace(/\\/g, '')]+"_";(tarteaucitron.job = tarteaucitron.job || []).push(tarteaucitron_services[t.toString().replace(/\\/g, '')]);}return t.test(e)}))&&(!a.whitelist||a.whitelist.every(function(t){return!t.test(e)}))}function s(t){var e=t.getAttribute("src");return a.blacklist&&a.blacklist.every(function(t){return!t.test(e)})||a.whitelist&&a.whitelist.some(function(t){return t.test(e)})}var u="javascript/blocked",a={blacklist:window.tarteaucitron_blacklist,whitelist:window.tarteaucitron_whitelist},f={blacklisted:[]},p=window.tarteaucitron_iframe,d={blacklisted:[]},y=new MutationObserver(function(t){for(var e=0;e<t.length;e++)for(var c=t[e].addedNodes,r=function(t){var r=c[t];if(1===r.nodeType&&"SCRIPT"===r.tagName){var e=r.src,n=r.type;if(l(e,n)){
...
if (typeof e !== "undefined" && !document.getElementById(e.replace(/\W/g,''))) {
   ...
   var timerms = 1200;
if (tarteaucitron.services['klaviyo'] !== undefined) {timerms = 0;}
